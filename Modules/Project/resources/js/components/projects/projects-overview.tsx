...
import { CheckCircle2, Clock, Filter, Search, TrendingUp, Users, X } from 'lucide-react';
import { useMemo, useState } from 'react';
import { Project, ProjectStatus, ViewMode, WorkloadLevel } from '../../types/types';
...
export const ProjectsOverview = ({ projects }: ProjectsOverviewProps) => {
    ...
    const [workloadFilter, setWorkloadFilter] = useState<WorkloadLevel | null>(null);
    ...
    const avgCapacity =
        projects.length > 0
            ? Math.round(projects.reduce((sum, p) => sum + p.capacity_used, 0) / projects.length)
            : 0;
    const tasksCompleted = projects.reduce((sum, p) => sum + p.tasks_completed, 0);
        ...
        <div className="min-h-screen">
            ...
            <div className="mb-5 flex flex-wrap items-center gap-2">
                <div className="relative min-w-[200px] flex-1">
                    ...
                    <input
                        ...
                        className="w-full rounded-md border border-gray-200 bg-white py-1.5 pl-8 pr-3 text-sm text-gray-700 focus:border-blue-500 focus:outline-none"
                    />
                </div>
                ...
                <select
                    ...
                    onChange={(e) => setWorkloadFilter((e.target.value as WorkloadLevel) || null)}
                    className="rounded-md border border-gray-200 bg-white px-2.5 py-1.5 text-xs text-gray-700 focus:border-blue-500 focus:outline-none"
                >
            ...
            {filtered.length === 0 ? (
                <div className="flex flex-col items-center justify-center gap-2 py-16 text-gray-400">
                    ...
                    <p className="text-sm">Žiadne projekty nezodpovedajú filtrom</p>
