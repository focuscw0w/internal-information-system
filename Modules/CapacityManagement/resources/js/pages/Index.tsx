    ...
    const updateCapacity = (event: FormEvent, userId: number) => {
        ...
        router.patch(`/capacity-management/users/${userId}/capacity`, {
            weekly_capacity_hours:
                capacities[userId] ??
                dashboard.people.find((p) => p.id === userId)
                    ?.weekly_capacity_hours ??
                40,
        });
    };
            ...
            <div className="space-y-6 p-6">
                ...
                <section className="space-y-4">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Hlavný blok ostáva stručný a detail si rozbalíš len
                            tam, kde chceš riešiť problém.
                        </p>
                    </div>
                    ...
                    <div className="space-y-3">
                        <Collapsible
                            ...
                            onOpenChange={() =>
                                toggleRecommendation('overloaded')
                            }
                                ...
                                <div className="space-y-3">
                                    ...
                                    {overloadedPeople.map((person) => {
                                        ...
                                        return (
                                            <div
                                                key={person.id}
                                                className="rounded-md border border-red-100 bg-red-50/60 p-3"
                                            >
                                                ...
                                                <p className="mt-2 text-xs text-gray-500">
                                                    Vhodný zásah: odobrať časť
                                                    práce, presunúť úlohy alebo
                                                    pridať ďalšieho človeka na
                                                    projekt.
                                                </p>
                                            </div>
                                        );
                                ...
                                <div className="space-y-3">
                                    ...
                                    {riskyProjects.map((project) => {
                                        ...
                                        return (
                                            <div
                                                key={project.id}
                                                className="rounded-md border border-orange-100 bg-orange-50/60 p-3"
                                            >
                                                <div className="flex items-center justify-between gap-2">
                                                    <span className="font-medium text-gray-900">
                                                        {project.name}
                                                ...
                                                <p className="mt-2 text-xs text-gray-500">
                                                    Vhodný zásah: pridať
                                                    kapacitu, odľahčiť tím alebo
                                                    posunúť termín projektu.
                                                </p>
                                            </div>
                                        );
                                    })}
                ...
                <section className="grid gap-4 md:grid-cols-2">
                    <div className="rounded-lg border bg-white p-4">
                        ...
                        <UtilizationBar
                            utilization={dashboard.weekly_overview.utilization}
                        />
                    </div>
                    <div className="rounded-lg border bg-white p-4">
                        ...
                        <UtilizationBar
                            utilization={dashboard.monthly_overview.utilization}
                        />
                    </div>
                </section>
